	...
	<form 
		...
		<table class="mx-auto">
				...
				<td>
					...
					<div id="memberId-container">
						<input type="text" 
							   ...
							   value="honggd"
							   required>		
						<span class="guide ok">입력하신 아이디는 사용 가능합니다.</span>			
			...
			<tr>
				<th>주소</th>
				<td>	
					<input type="text" class="form-control" placeholder="" name="address" id="address" value="서울시 강남구 테헤란로">
				</td>
			</tr>
			<tr>
				<th>성별 </th>
				<td>
					<div class="form-check form-check-inline">
						...
						<input type="radio" class="form-check-input" name="gender" id="gender1" value="F" checked>
...
$(id).keyup((e) => {
	...
	$.ajax({
		...
		success(data) {
			console.log(data); // json이 넘어왔음 // {available: true, num: 12345, member: null}
			const {available} = data;
			if(available) {
				$ok.show();
				$error.hide();
				$idValid.val(1); // idValid 값을 1로 셋팅
			}
			else {
				$ok.hide();
				$error.show();
