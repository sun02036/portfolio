...
<div id="demo-container" 
	...
	<form id="devFrm" method="POST">
		...
		<div class="form-group row">
		  ...
		  <div class="col-sm-10">
		    <input type="email" class="form-control" id="email" name="email" value="honggd@naver.com" required>
		  </div>
		</div>
	...
	<div class="list-group">
	  ...
	  <button type="button" onclick="submitProcess('insertDev');" class="list-group-item list-group-item-action">DB - insert</button>
	</div>
</div>
